...
- Rejects explicitly blank merchant IDs and database paths during configuration loading, before opening the ledger or listening; omitted defaults and nonblank values remain unchanged.
